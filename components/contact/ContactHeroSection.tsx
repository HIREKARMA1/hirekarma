...
export default function ContactHeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative content-container pb-8 pt-16 lg:pb-10 lg:pt-[4.75rem]">
        <div className="max-w-2xl space-y-3">
          ...
          <p className="max-w-xl text-sm leading-snug text-white/65 lg:text-[15px]">
            {hero.description}
          </p>
          <div className="flex flex-wrap items-center gap-3 pt-1">
            ...
            <Link
              href="#contact-form"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-white transition hover:text-[#00a2e5]"
            >
              {hero.formJump}
