...
function CaseStudiesPageInner() {
  ...
  const filteredStudies = caseStudiesContent.studies.filter((study) => {
    const matchesFilter =
      selectedFilter === "all" || study.filterId === selectedFilter;
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96">
                  ...
                  <input
                    type="text"
                    placeholder={caseStudiesContent.searchPlaceholder}
                    value={searchQuery}
          ...
          <div className="relative content-container py-8">
            <div className="max-w-7xl mx-auto">
              <div className="flex items-center gap-3 mb-10">
                ...
                >
                  {caseStudiesContent.featuredTitle}
                </h2>
              </div>
