                            ...
                            <div className="space-y-8 lg:space-y-10">
                                ...
                                <div className="space-y-4">
                                    <p className={`text-lg sm:text-xl leading-relaxed max-w-2xl ${
                                        ...
                                        Founded in <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                                        }`}>Bhubaneswar in 2020</strong>, HireKarma emerged from a vision to <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                                    ...
                                    <p className={`text-lg sm:text-xl leading-relaxed max-w-2xl ${
                                        ...
                                        Founded in <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                                        }`}>Bhubaneswar in 2020</strong> by <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                                        }`}>Sohan Kumar Dey</strong> and <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                            ...
                            <div className="space-y-8 lg:space-y-10 lg:order-1 order-2">
                                ...
                                <div className="space-y-4">
                                    <p className={`text-lg sm:text-xl leading-relaxed max-w-2xl ${
                                        ...
                                        Recognizing that many <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                                        }`}>talented graduates face roadblocks</strong> to meaningful employment, we identified the <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                            ...
                            <div className="space-y-8 lg:space-y-10">
                                ...
                                <div className="space-y-4">
                                    <p className={`text-lg sm:text-xl leading-relaxed max-w-2xl ${
                                        ...
                                        The founders set out to <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
                                        }`}>transform campus recruitment</strong> through AI automation, <strong className={`${
                                            mounted && resolvedTheme === 'dark' 
                                                ? 'text-gray-200' 
                                                : 'text-gray-700'
