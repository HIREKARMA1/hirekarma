            ...
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 xl:gap-8">
                {teamMembers.map((member, index) => (
                  <div
                    key={index}
                    className={`rounded-lg border shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col ${mounted && resolvedTheme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}
                  >
