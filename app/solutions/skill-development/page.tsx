                            ...
                            <div className="space-y-8 lg:space-y-10">
                                ...
                                <div className="space-y-4">
                                    <p className={`text-lg sm:text-xl leading-relaxed max-w-2xl ${
                                        ...
                                        HireKarma equips skilling centers and development organizations with <strong className={`${
                                        ...
                                        hiring opportunities. Our scalable, modular platform integrates <strong className={`${
                                            mounted && resolvedTheme === 'dark' ? 'text-gray-200' : 'text-gray-700'
